...
class _$_CommentLike implements _CommentLike {
  ...
  @override
  String toString() {
    return 'CommentLike(activeUid: $activeUid, createdAt: $createdAt, postCommentCreatorUid: $postCommentCreatorUid, postCommentId: $postCommentId, postCommentRef: $postCommentRef)';
  }
...
abstract class _CommentLike implements CommentLike {
  const factory _CommentLike(
      ...
      required final dynamic postCommentRef}) = _$_CommentLike;
